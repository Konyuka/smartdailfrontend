              ...
              <div class="items-center">
                <div class="">
                  ...
                  <div
                    ...
                    <button v-if="ready" @click="toggle('PAUSED')" type="button"
                    ...
                    <button v-else @click="toggle('Ready')" type="button"
                            class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-black bg-blue-400 hover:text-black hover:bg-white focus:outline-none">
                      <span class="flex">
...
export default {
    ...
    campaign(newValue) {
      if (newValue == null) {
        let payload = {
          ...
          text: 'Phone disconnected,kindly call again to login to a campaign to start using the system',
        }
  ...
  methods: {
      ...
      return this.$http
          ...
          .catch(error => {
            let payload = {
              ...
              text: 'There are no dialable leads in your Campaign. Kindly consult your Team leader'
            }
            this.$store.dispatch("resetError", payload);
            this.tryAgain = false
            //this.errorModal = true
    ...
    dial(number) {
      ...
      return this.$http.post("/api/v1/dial/manual", payload, {
        headers: {
          "Content-Type": "application/json",
          "Accept": "application/json",
          "Authorization": `Bearer ${localStorage.getItem('token')}`
    ...
    deleteCallback(item) {
      ...
      return this.$http
          .post("/api/v1/dial/deleteCallback", payload, {
            headers: {
              "Content-Type": "application/json",
              "Accept": "application/json",
              "Authorization": `Bearer ${localStorage.getItem('token')}`
