      ...
      <div
        ...
        <nav class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto static">
          ...
          <div class="mt-3 text-center sm:mt-5">
            <h3 v-if="!ongoingCall && callOn" class="text-sm italic leading-6 font-medium text-white"
                id="modal-headline">
          ...
          <div class="mt-5 sm:mt-6 text-center absolute bottom-24 left-24">
            <div class="">
              ...
              <!-- hang -->
              <button @click='hangUp' :class="{'hidden': callOn == false, 'block': callOn == true}" type="button"
